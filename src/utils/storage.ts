 ...
 */
export const saveConversations = (conversations: Record<string, Message[]>): void => {
  try {
...
export const saveNpcRelationships = (npcProfiles: NPCProfile[]): void => {
  try {
    ...
    localStorage.setItem(STORAGE_KEYS.NPC_RELATIONSHIPS, JSON.stringify(relationships))
  } catch (error) {
